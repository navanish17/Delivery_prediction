...
class DataTransformationConfig():
    proccessed_obj_file_path = PREPROCESSING_OBJ_PATH
    transform_train_path = TRANSFORMED_TRAIN_FILE_PATH
    transform_test_path = TRANSFORMED_TEST_FILE_PATH
    feature_engg_obj_path = FEATURE_ENG_OBJ_PATH
